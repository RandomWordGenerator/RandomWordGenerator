...
def _make_romaji_convertor():
    ...
    master = {
        ...
        'guxa': 'グァ', 'guxi': 'グィ', 'guxu': 'グゥ', 'guxe': 'グェ', 'guxo': 'グォ',
    ...
    romaji_asist = {
        ...
        't': 'ト', 'v': 'ヴ', 'w': 'ゥ', 'x': 'クス', 'y': 'ィ', 'z': 'ズ', 'n': 'ン'
    }

    kana_asist = {'xa': 'ァ', 'xi': 'ィ', 'xu': 'ゥ', 'xe': 'ェ', 'xo': 'ォ', }
